      ...
      <div
        className={cn(
          ...
          theme === "light"
            ...
            : "bg-stone-800 shadow-gold-500/10 shadow-lg",
        )}
      >
...
export default function LandingPage({ onGoToLogin }) {
  ...
  return (
    ...
    >
      ...
      {/* Navigation */}
      <nav className="container mx-auto px-4 md:px-8 py-6 md:py-8 flex justify-between items-center relative z-50">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-stone-900 rounded-xl flex items-center justify-center shadow-lg min-w-10">
      ...
      {/* Hero Section */}
      <section className="container mx-auto px-4 md:px-8 pt-16 md:pt-20 pb-24 md:pb-32 text-center relative z-10">
        <motion.div
        ...
        >
          ...
          <h1 className="text-5xl sm:text-6xl md:text-8xl font-serif font-bold mb-6 md:mb-8 leading-[1.1] tracking-tight">
            {t("landing.hero_title")}{" "}
            <span className="text-gold-500 italic inline-block pr-2">
          ...
          >
            ...
            <ArrowRight
              ...
              color={theme === "light" ? "#ffffff" : "#1C1917"}
            />
      ...
      {/* Features Grid */}
      <section className="container mx-auto px-4 md:px-8 py-20 md:py-32 relative z-10">
      ...
      <footer
        className={cn(
          "container mx-auto px-4 md:px-8 py-8 md:py-12 border-t text-center opacity-50 text-[10px] uppercase tracking-[0.3em]",
          theme === "light" ? "border-stone-200" : "border-stone-900 font-bold",
        )}
      >
        &copy; 2026 Premium Store AI. All Rights Reserved.
      </footer>
    </div>
  );
}
